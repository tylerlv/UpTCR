...
def main(args):
    ...
    if config.task == 'TCRABpMHC_majority':
    ...
    Trainer.test(test_loader, f'best_val', True, 'majority')


if __name__ == '__main__':
    parser = ArgumentParser()

    parser.add_argument('--config', type=str, default='configs/config-train-TCRABpMHC_majority.yml')
