...
from UpTCR.trainer.tcrabp_trainer import TCRABpTrainer
...
def main(args):
    ...
    Trainer.test(test_loader, 'best_val', True, 'zeroshot')

if __name__ == '__main__':
    parser = ArgumentParser()

    parser.add_argument('--config', type=str, default='configs/config-train-TCRABp_unseen.yml')
