...
from UpTCR.trainer.tcrbp_trainer import TCRBpTrainer
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', type=str, default='configs/config-train-TCRBp_unseen.yml')
